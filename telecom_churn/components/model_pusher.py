...
from telecom_churn.cloud_storage.aws_storage import SimpleStorageService
from telecom_churn.exception import TelecomChurnException
from telecom_churn.logger import logging
from telecom_churn.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from telecom_churn.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = TelecomChurnEstimator(bucket_name=model_pusher_config.bucket_name,
